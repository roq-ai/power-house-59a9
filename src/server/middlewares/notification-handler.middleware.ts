...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'booking.create': { roles: ['gym-trainer', 'business-owner'], key: 'booking_id', tenantPath: [], userPath: [] },
  'diet_plan.create': { roles: ['gym-member', 'business-owner'], key: 'diet_plan_id', tenantPath: [], userPath: [] },
  'schedule.update': { roles: ['gym-member', 'business-owner'], key: 'schedule_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['business-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['business-owner', 'gym-trainer', 'gym-member', 'nutritionist', 'guest-user'];
