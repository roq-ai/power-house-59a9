...
import { getGymTrainerById } from 'apiSdk/gym-trainers';
import { GymTrainerInterface } from 'interfaces/gym-trainer';
import { TrainingCourseListPage } from 'pages/training-courses';

function GymTrainerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('gym_trainer', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/gym-trainers/edit/${id}`} passHref legacyBehavior>
                    <Button
