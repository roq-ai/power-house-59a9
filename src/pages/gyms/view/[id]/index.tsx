...
import { GymMemberListPage } from 'pages/gym-members';
import { GymTrainerListPage } from 'pages/gym-trainers';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('gym', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/gyms/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="gym" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
