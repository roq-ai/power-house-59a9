...
import { getGymMemberById } from 'apiSdk/gym-members';
import { GymMemberInterface } from 'interfaces/gym-member';

function GymMemberViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('gym_member', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/gym-members/edit/${id}`} passHref legacyBehavior>
                    <Button
                ...
                <FormListItem
                  ...
                  text={
                    data?.membership_start_date
                      ? format(parseISO(data?.membership_start_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
                ...
                <FormListItem
                  ...
                  text={
                    data?.membership_end_date
                      ? format(parseISO(data?.membership_end_date as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
